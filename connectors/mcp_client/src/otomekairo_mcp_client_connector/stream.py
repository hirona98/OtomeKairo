...
class EventStreamClient:
    ...
    def _connect(self) -> None:
        ...
        websocket: socket.socket | ssl.SSLSocket
        ...
        expected_accept = base64.b64encode(hashlib.sha1(f"{key}{WEBSOCKET_GUID}".encode("utf-8")).digest()).decode("ascii")
    ...
    def _read_http_response(self) -> tuple[int, dict[str, str]]:
        ...
        try:
            ...
            raise StreamError(f"invalid event stream status line: {lines[0]}") from exc
