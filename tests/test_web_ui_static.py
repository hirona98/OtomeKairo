...
class WebUiStaticTests(unittest.TestCase):
    ...
    def test_web_ui_index_is_served_without_token(self) -> None:
        ...
        self.assertIn('id="persona-interlocutor-address-term"', html)
    ...
    def test_web_ui_assets_are_served_without_token(self) -> None:
        ...
        self.assertIn(b"interlocutor_address_term", js_body)
        self.assertNotIn(b"interlocutor_default_reference", js_body)
