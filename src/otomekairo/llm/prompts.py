    ...
    if initiative_context is not None:
        policies.extend(
            [
                ...
                "foreground_signal_summary.desktop_observation_signal.cooldown_active=true の場合、cooldown は割り込み量を控える調整材料です。新しい desktop novelty は保留候補として扱い、強い前進理由がなければ noop を選んでください。",
