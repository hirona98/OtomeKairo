(() => {
  ...
  const MEMORY_RETRIEVAL_DESCRIPTORS = [
    ...
    { path: "memory.tidy_min_interval_ms", label: "保守最小間隔(ms)", kind: "integer", min: 60000, max: 604800000, step: 1000 },
    { path: "memory.tidy_completed_jobs_retention_ms", label: "完了job保持(ms)", kind: "integer", min: 60000, max: 604800000, step: 1000 },
    { path: "memory.tidy_completed_jobs_trigger_count", label: "完了job掃除閾値", kind: "integer", min: 1, max: 1000000, step: 1 },
    { path: "memory.tidy_preview_retention_ms", label: "preview保持(ms)", kind: "integer", min: 60000, max: 604800000, step: 1000 },
    { path: "memory.tidy_preview_trigger_count", label: "preview掃除閾値", kind: "integer", min: 1, max: 1000000, step: 1 },
    { path: "memory.tidy_vector_retention_ms", label: "vector保持(ms)", kind: "integer", min: 60000, max: 604800000, step: 1000 },
    { path: "memory.tidy_vector_trigger_count", label: "vector掃除閾値", kind: "integer", min: 1, max: 1000000, step: 1 },
