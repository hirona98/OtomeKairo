    ...
    def _complete_input_success(
        ...
        *,
        ...
        events = self._persist_cycle_success(
            ...
            self_state_context=pipeline.get("self_state_context"),
            relationship_context=pipeline.get("relationship_context"),
            prediction_error_context=pipeline.get("prediction_error_context"),
            default_mode_context=pipeline.get("default_mode_context"),
