...
SETTING_DEFINITIONS: tuple[SettingDefinition, ...] = (
    ...
    SettingDefinition("memory.tidy_min_interval_ms", "integer", ("runtime", "next_boot"), min_value=60000, max_value=604800000),
    SettingDefinition("memory.tidy_completed_jobs_retention_ms", "integer", ("runtime", "next_boot"), min_value=60000, max_value=604800000),
    SettingDefinition("memory.tidy_completed_jobs_trigger_count", "integer", ("runtime", "next_boot"), min_value=1, max_value=1000000),
    SettingDefinition("memory.tidy_preview_retention_ms", "integer", ("runtime", "next_boot"), min_value=60000, max_value=604800000),
    SettingDefinition("memory.tidy_preview_trigger_count", "integer", ("runtime", "next_boot"), min_value=1, max_value=1000000),
    SettingDefinition("memory.tidy_vector_retention_ms", "integer", ("runtime", "next_boot"), min_value=60000, max_value=604800000),
    SettingDefinition("memory.tidy_vector_trigger_count", "integer", ("runtime", "next_boot"), min_value=1, max_value=1000000),
        ...
        "memory_presets": (
            {
                ...
                "payload": {
                    ...
                    "memory.tidy_min_interval_ms": int(default_settings["memory.tidy_min_interval_ms"]),
                    "memory.tidy_completed_jobs_retention_ms": int(default_settings["memory.tidy_completed_jobs_retention_ms"]),
                    "memory.tidy_completed_jobs_trigger_count": int(default_settings["memory.tidy_completed_jobs_trigger_count"]),
                    "memory.tidy_preview_retention_ms": int(default_settings["memory.tidy_preview_retention_ms"]),
                    "memory.tidy_preview_trigger_count": int(default_settings["memory.tidy_preview_trigger_count"]),
                    "memory.tidy_vector_retention_ms": int(default_settings["memory.tidy_vector_retention_ms"]),
                    "memory.tidy_vector_trigger_count": int(default_settings["memory.tidy_vector_trigger_count"]),
                    "retrieval_profile": {
                        "semantic_top_k": 8,
