...
def _build_decision_system_prompt(persona: dict) -> str:
    ...
    return (
        ...
        "InitiativeContext には initiative_baseline, runtime_state_summary, recent_turn_summary, candidate_families, selected_candidate_family, intervention_state が入りえます。\n"
        ...
        "intervention_state や intervention_risk_summary が強いとき、特に background_wake や initiative_baseline=low では、押し出しすぎず noop を優先してください。\n"
...
def _build_world_state_system_prompt() -> str:
    return (
        ...
        "screen_context / external_service_context / body_context / device_context / schedule_context があるときは、その短い summary_text と補助 field だけを根拠に使ってください。\n"
        ...
        "body_context.body_state_summary、device_context.device_state_summary、schedule_context.schedule_summary は各 state_type の短い補助要約として使ってよいです。\n"
