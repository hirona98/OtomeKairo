...
- `src/otomekairo/runtime/main_loop.py`: `settings_overrides` と `pending_inputs` を消費し、`ui_outbound_events` と `commit_records` まで閉じ、`runtime.idle_tick_ms` を待機間隔に使う最小ランタイムを持つ
