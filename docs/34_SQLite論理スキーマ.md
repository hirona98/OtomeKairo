...
<!-- Block: Entity Tables -->
### `event_about_time` と `event_entities` と `state_entities`
...
- 同じ長周期 transaction に含めるのは、`memory_jobs`、`memory_states`、`preference_memory`、`event_affects`、`event_links`、`event_threads`、`event_about_time`、`state_links`、`event_entities`、`state_entities`、`event_preview_cache`、`revisions`、`vec_items`、`vec_items_index`、必要なら `self_state` と `skill_registry` とする
