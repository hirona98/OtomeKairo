...
- `experience_fit` は、`preference_alignment` と `aversion_penalty` に加えて、`memory_bundle.relationship_items`、`memory_bundle.preference_items`、`memory_bundle.affective_items`、`memory_bundle.reflection_items`、直近の `last_persona_update_summary` を反映してよい
