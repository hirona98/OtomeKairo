...
- current 実装では、`selection_profile` から compact な人格要約を作り、`trait_values`、`interaction_style`、`learned_preferences`、`learned_aversions`、`habit_biases`、`emotion_bias`、`drive_bias` を毎周期の prompt self layer に明示展開してよい
