...
- current 実装では、`selected_json.selector_summary.selector_mode=\"llm_ranked\"`、`selection_reason`、`llm_selected_ref_count`、`slot_skipped_count` を追加し、`LLM` が返した順序と slot 上限適用結果を監査できるようにしてよい
