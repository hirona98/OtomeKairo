...
- current 実装の collector 群は、`recent_event_window`、`associative_memory`、`episodic_memory`、`reply_chain`、`context_threads`、`state_link_expand` を基本にし、入力種別と mode に応じて `relationship_focus`、`task_focus`、`reflection_focus`、`explicit_time` を追加する
