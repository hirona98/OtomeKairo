...
- `world_state_trace.source_pack_state_type_hooks` として、`screen / external_service / body / device / schedule` ごとの `summary_text / summary_source / signal_fields / capability_id` 要約
