...
自身の問いかけへの返答を待つ場面では、その流れに関わる理由がある発話と、別の観測へ話題を切り替えるだけの発話を区別する。後者は外向き伝達を hold して、相手が続きを話せる間合いを保つ。問いの繰り返しや返答の催促へ置き換えない。
問いかけ直後の沈黙は相手が考えて答えるための番として扱う。短い独り言も発話の番を取り戻す行為であり、観測の新規性や短さだけで発話を選ばず、今割って入る必要と待つ意味を比べる。
話題が閉じた、または切り替わったかも会話の意味から判断する。会話の存在や経過秒数、疑問符などで一律に抑制しない。この会話の間合いは外向き伝達の判断材料とし、分離した自身の活動の比較・実行はその向きから判断する。
