...
capability の意味境界、manifest、availability、decision view は [17_capability_manifest.md](17_capability_manifest.md) を正とする。
capability request / result の wire 契約は [api/05_実行連携.md](api/05_実行連携.md) を正とする。
