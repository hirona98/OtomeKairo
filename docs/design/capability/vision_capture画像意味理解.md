...
視覚 source と `vision.capture` の意味境界は [視覚機能.md](視覚機能.md) を正とする。
通常会話の添付画像の API 入力は [対話画像入力.md](対話画像入力.md) を正とする。
`world_state` への反映は [../runtime/world_state.md](../runtime/world_state.md) を正とする。
...
視覚 source と capability 実行の境界は [視覚機能.md](視覚機能.md) を参照する。
...
- 視覚 source と capability 実行の境界は [視覚機能.md](視覚機能.md) を正とする
- `world_state` への反映先は [../runtime/world_state.md](../runtime/world_state.md) を正とする
- capability wire は [../api/実行連携.md](../api/実行連携.md) を正とする
- repo 全体の LLM 判断原則は [../llm/LLM判断優先方針.md](../llm/LLM判断優先方針.md) を正とする
