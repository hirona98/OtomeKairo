...
| [design/integration/](design/integration/) | 外部接点、権限境界、connector 配置、OtomeKairo / CocoroConsole / CocoroShell の関係、ブラウザ UI 見た目規約 |
...
- ブラウザ UI 通常画面（topbar・内部状態・チャット・composer・statusbar）の見た目規約は [design/integration/WebUI通常画面規約.md](design/integration/WebUI通常画面規約.md) を正本とする
