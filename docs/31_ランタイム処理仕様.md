...
- `reply_render_input` は、`reply_render` 専用の派生断面であり、`observation_text`、`time_reference_text`、`attention_summary_text`、`retrieval_summary_text`、`stable_self_state`、`confirmed_preferences`、`long_mood_state`、`recent_dialog`、`selected_memory_pack`、`reply_style` だけを持つ
